...
class TemperatureMachine(StateMachine):
    ...
    def on_enter_heat(self):
        ## Turn on red light indicating heat mode
    ...
    def on_enter_cool(self):
        ##Turn on the blue light indicating cool mode
    ...
    def processTempIncButton(self):
        ...
        ##Increment setPoint and update LEDs
    ...
    def processTempDecButton(self):
        ...
        ##Decrement setPoint and update LEDs
    ...
    def updateLights(self):
        ...
        ##Pulse corisponding LED if heater/AC would be active else solid LED corisponding to current state
    ...
    def setupSerialOutput(self):
        ##Output line for serial monitor

        output = "Mode:" + self.current_state.id + "," + str(round(self.getFahrenheit(), 2)) + "F," + str(self.setPoint) + "F"
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            stats = self.setupSerialOutput().split(',')
            ## Ouput for LCD screen


            lcd_line_1 = current_time.strftime("%I:%M %m/%d/%Y") + "\n"
    
            ## Setup Display Line 2
            if(altCounter < 6):

                lcd_line_2 = "Temp: " + stats[1]
    
                altCounter = altCounter + 1
            else:

                lcd_line_2 = stats[0] + ",Set:" + stats[2]
...
##When green button pressed, cycle SM state
...
##
redButton = Button(25)
## When red button pressed, increment setPoint
...
##When blue button pressed, Decrement setpoint
